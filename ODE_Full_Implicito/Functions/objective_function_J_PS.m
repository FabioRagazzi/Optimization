function [error_vector] = objective_function_J_PS(parametri, Jobjective, time_instants, P)
% OBJECTIVE_FUNCTION_J_PS Fitness function for a fit with PS  
...
error_vector = Inf;
if size(J_dDdt) == size(Jobjective)
    error_vector = norm((log10(Jobjective) - log10(J_dDdt))./log10(Jobjective));
end
